...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "orders" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"form_type" varchar DEFAULT 'order',
  ...
  CREATE TABLE "partners" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"form_type" varchar DEFAULT 'partner',
  	"first_name" varchar NOT NULL,
  	"last_name" varchar NOT NULL,
  	"email" varchar NOT NULL,
  	"message" varchar,
  	...
  	"shop_neighborhood" varchar,
  	"shop_address" varchar,
  	"shop_phone" varchar,
  	"shop_whatsapp" varchar,
  	"shop_instagram" varchar,
  	"shop_website" varchar,
  	"shop_description" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  
  CREATE TABLE "shops_gallery" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "shops_specialties" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"label" varchar
  ...
  CREATE TABLE "lookbook_products_sizes" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"size" varchar
  ...
  CREATE TABLE "lookbook_products_colors" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"color" varchar
  ...
  CREATE TABLE "payload_locked_documents_rels" (
  	...
  	"lookbook_products_id" integer,
  	"beauty_products_id" integer,
  ...
  ALTER TABLE "lookbooks" ADD CONSTRAINT "lookbooks_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "lookbook_products_sizes" ADD CONSTRAINT "lookbook_products_sizes_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."lookbook_products"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "lookbook_products_colors" ADD CONSTRAINT "lookbook_products_colors_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."lookbook_products"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "lookbook_products" ADD CONSTRAINT "lookbook_products_lookbook_id_lookbooks_id_fk" FOREIGN KEY ("lookbook_id") REFERENCES "public"."lookbooks"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "lookbook_products" ADD CONSTRAINT "lookbook_products_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "beauty_products" ADD CONSTRAINT "beauty_products_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_lookbook_products_fk" FOREIGN KEY ("lookbook_products_id") REFERENCES "public"."lookbook_products"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_beauty_products_fk" FOREIGN KEY ("beauty_products_id") REFERENCES "public"."beauty_products"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "shops_gallery_order_idx" ON "shops_gallery" USING btree ("_order");
  CREATE INDEX "shops_gallery_parent_id_idx" ON "shops_gallery" USING btree ("_parent_id");
  CREATE INDEX "shops_gallery_image_idx" ON "shops_gallery" USING btree ("image_id");
  CREATE INDEX "shops_specialties_order_idx" ON "shops_specialties" USING btree ("_order");
  CREATE INDEX "shops_specialties_parent_id_idx" ON "shops_specialties" USING btree ("_parent_id");
  CREATE UNIQUE INDEX "shops_slug_idx" ON "shops" USING btree ("slug");
  CREATE INDEX "shops_image_idx" ON "shops" USING btree ("image_id");
  ...
  CREATE INDEX "shops_rels_products_id_idx" ON "shops_rels" USING btree ("products_id");
  ...
  CREATE INDEX "lookbooks_image_idx" ON "lookbooks" USING btree ("image_id");
  ...
  CREATE INDEX "lookbook_products_sizes_order_idx" ON "lookbook_products_sizes" USING btree ("_order");
  CREATE INDEX "lookbook_products_sizes_parent_id_idx" ON "lookbook_products_sizes" USING btree ("_parent_id");
  CREATE INDEX "lookbook_products_colors_order_idx" ON "lookbook_products_colors" USING btree ("_order");
  CREATE INDEX "lookbook_products_colors_parent_id_idx" ON "lookbook_products_colors" USING btree ("_parent_id");
  CREATE INDEX "lookbook_products_lookbook_idx" ON "lookbook_products" USING btree ("lookbook_id");
  CREATE INDEX "lookbook_products_image_idx" ON "lookbook_products" USING btree ("image_id");
  CREATE INDEX "lookbook_products_updated_at_idx" ON "lookbook_products" USING btree ("updated_at");
  CREATE INDEX "lookbook_products_created_at_idx" ON "lookbook_products" USING btree ("created_at");
  CREATE INDEX "beauty_products_image_idx" ON "beauty_products" USING btree ("image_id");
  CREATE INDEX "beauty_products_updated_at_idx" ON "beauty_products" USING btree ("updated_at");
  CREATE INDEX "beauty_products_created_at_idx" ON "beauty_products" USING btree ("created_at");
  ...
  CREATE INDEX "payload_locked_documents_rels_lookbook_products_id_idx" ON "payload_locked_documents_rels" USING btree ("lookbook_products_id");
  CREATE INDEX "payload_locked_documents_rels_beauty_products_id_idx" ON "payload_locked_documents_rels" USING btree ("beauty_products_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "shops_gallery" CASCADE;
  DROP TABLE "shops_specialties" CASCADE;
  ...
  DROP TABLE "lookbook_products_sizes" CASCADE;
  DROP TABLE "lookbook_products_colors" CASCADE;
  DROP TABLE "lookbook_products" CASCADE;
  DROP TABLE "beauty_products" CASCADE;
  ...
  DROP TYPE "public"."enum_products_filter_category";
  DROP TYPE "public"."enum_lookbook_products_badge";
